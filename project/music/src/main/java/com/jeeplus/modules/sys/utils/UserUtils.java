...
import com.jeeplus.common.utils.ShortMsgUtils;
...
//		getCacheMap().remove(key);
	...
	//发送注册码
	public static String sendRandomCode(String tel, String randomCode) throws IOException {
		//发送内容
		String content = "您的验证码是："+randomCode+"，有效期30分钟，请在有效期内使用。";

		return ShortMsgUtils.sendShotMsg(tel, randomCode);
