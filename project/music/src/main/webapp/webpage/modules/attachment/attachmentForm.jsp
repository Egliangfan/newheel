...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="attachment" action="${ctx}/attachment/attachment/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<input id="creatDate" name="creatDate" type="text" maxlength="20" class="laydate-icon form-control layer-date "
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="fileType" htmlEscape="false"    class="form-control "/>
					</td>
