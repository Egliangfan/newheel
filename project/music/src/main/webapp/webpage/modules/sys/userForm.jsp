		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
			  ...
			  <tr>
				  ...
				  <td><form:input path="nickname" htmlEscape="false" maxlength="100" class="form-control"/></td>
				  <td class="active"><label class="pull-right">性别:</label></td>
				  <td><form:input path="sex" htmlEscape="false" maxlength="100" class="form-control"/></td>
			  </tr>

			  <tr>
				  <td class="active"><label class="pull-right">城市:</label></td>
				  <td><form:input path="city" htmlEscape="false" maxlength="100" class="form-control"/></td>
				  <td class="active"><label class="pull-right">生日:</label></td>
				  <td><form:input path="birthday" htmlEscape="false" maxlength="100" class="form-control"/></td>
			  </tr>
			  ...
			  <tr>
				  <td class="active"><label class="pull-right">个人介绍:</label></td>
				  <td><form:textarea path="introduction" htmlEscape="false" rows="3" maxlength="200" class="form-control"/></td>
