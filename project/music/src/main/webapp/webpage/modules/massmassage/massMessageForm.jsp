...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="massMessage" action="${ctx}/massmassage/massMessage/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					<td class="width-15 active"><label class="pull-right">发送日期：</label></td>
					<td class="width-35">
						<form:input path="senddate" htmlEscape="false"    class="form-control "/>
					</td>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="week" htmlEscape="false"    class="form-control "/>
					</td>
