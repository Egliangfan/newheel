...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="workplace" action="${ctx}/workplace/workplace/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>地理位置：</label></td>
					<td class="width-35">
					...
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>详细位置：</label></td>
					<td class="width-35">
